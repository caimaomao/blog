...
$(function () {
  ...
  $('#header .member').hover(function () {
    $(this).css('background', 'url(image/arrow2.png) no-repeat 55px center');
    ...
    $(this).css('background', 'url(image/arrow.png) no-repeat 55px center');
  ...
  */
  ...
  $('#photo_big .close').click(function () {
    ...
    $('#photo_big .big img').attr('src', 'image/loading.gif').css('width', '32px').css('height', '32px').css('top', '190px');
  });
...
window.onload=function(){
 ...
 window.onload=function(){
	$().getByClass('member').hover(function(){

	   $(this).css('background','url(image/arrow2.png) no-repeat 55px center');
       $().getByClass('member_ul').show();
	},function(){
	   $(this).css('background','url(image/arrow.png) no-repeat 55px center')
       $().getByClass('member_ul').hide();
	});
	...
	$().getByClass('login').click(function(){
		login.center(350,250);
        login.show();
        screen.lock();
	});
	$().getByClass('close').click(function(){
        login.hide();
        screen.unlock();
	});

	//拖拽
	login.drag([$().getByTag('h2').getElement(0),$().getByTag('span').getElement(0)]);
